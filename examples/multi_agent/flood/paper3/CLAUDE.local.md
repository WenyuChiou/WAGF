...
**Comparison baseline:** Traditional FLOODABM (Bayesian regression + Bernoulli trial, ~52K households, PRB 2011-2023, 15 MC runs, no institutional agents, no social network). For local reproduction, set `TRAD_ABM_BASE` or `TRAD_ABM_CSV` to the private baseline export location.
