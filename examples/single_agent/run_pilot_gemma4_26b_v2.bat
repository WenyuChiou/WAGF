...
python examples\single_agent\run_flood.py --model gemma4:26b --years 10 --agents 100 --workers 1 --governance-mode strict --memory-engine humancentric --window-size 5 --thinking-mode disabled --initial-agents "%PROFILES%" --output "examples\single_agent\results\JOH_FINAL_v2_pilot\gemma4_26b\Group_C\Run_1" --seed 42 --num-ctx 8192 --num-predict 1536
...
python examples\single_agent\run_flood.py --model gemma4:26b --years 10 --agents 100 --workers 1 --governance-mode disabled --memory-engine humancentric --window-size 5 --thinking-mode disabled --initial-agents "%PROFILES%" --output "examples\single_agent\results\JOH_ABLATION_DISABLED_v2_pilot\gemma4_26b\Group_C_disabled\Run_1" --seed 42 --num-ctx 8192 --num-predict 1536
