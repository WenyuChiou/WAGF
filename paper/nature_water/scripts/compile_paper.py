...
NW_DIR = REPO_ROOT / "paper" / "nature_water"
DRAFTS = NW_DIR / "drafts"
OUTPUT = NW_DIR
...
def compile_main_paper():
    ...
    # ==================== TITLE ====================
    para = doc.add_paragraph()
    run = para.add_run("Institutional Constraints Shape Adaptive Strategy Diversity\nin Language-Based Water Agents")
...
def compile_si():
    ...
    para = doc.add_paragraph()
    run = para.add_run("Institutional Constraints Shape Adaptive Strategy Diversity in Language-Based Water Agents")
