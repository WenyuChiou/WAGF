...
% Hallucination = physically impossible given prior state
%   (e.g., elevate already-elevated home)

% 3.3 Effective Behavioral Entropy (EBE)
% EBE = H_norm × (1 - R_H)
% Range [0,1]: 0 = no diversity or all hallucinated, 1 = perfect diversity
% Novel contribution: single metric capturing both hallucination and diversity
...
The SAGE framework, all experiment configurations, simulation logs, and
analysis scripts are available at [GitHub URL] under the MIT License.
Simulation data are archived at [Zenodo DOI].
