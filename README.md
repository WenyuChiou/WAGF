...
```
?嚙踝蕭??嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙?嚙??
??                     Governance Broker                           ??
?? Validates LLM outputs against domain rules before execution     ??
??                                                                 ??
?? Context ??LLM ??Parse ??Validate ??Approve ??Execute           ??
??           ??                 ??                                  ??
??           ?嚙踝蕭??嚙?嚙?嚙?retry with ?嚙?嚙??(if ERROR)                       ??
??                 feedback                                        ??
??                                                                 ??
