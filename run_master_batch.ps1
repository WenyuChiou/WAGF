...
foreach ($engine in $engines) {
    ...
    $outputDir = "examples/single_agent/results_window"
...
Write-Host "Experimental results available in 'results_window' and 'results_humancentric'."
Write-Host "NOTE: Pre-framework 'old results' remains untouched."
