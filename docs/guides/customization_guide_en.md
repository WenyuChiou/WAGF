...
|-----------|--------|-----------------|
| Flood Adaptation | PMT (Rogers, 1983) | `examples/single_agent/` or `examples/governed_flood/config/` |
| Irrigation ABM | Cognitive Appraisal Theory (Hung & Yang, 2021) | `examples/irrigation_abm/config/` |
